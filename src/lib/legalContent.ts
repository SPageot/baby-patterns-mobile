...
export function getTermsOfUse(_locale?: string): LegalSection[] {
  return TERMS_OF_USE
}

export function getPrivacyPolicy(_locale?: string): LegalSection[] {
  return PRIVACY_POLICY
}

export function getLegalLastUpdated(_locale?: string): string {
...
export const TERMS_OF_USE: LegalSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      'Some features let users share content with others, including Parents Corner posts and comments, product reviews, and Parent Solutions Board posts. Community content reflects the views of the person who posted it, not Baby Pattern.',
      'If you see content that violates these Terms, use the in-app report option on that post, comment, review, or note. You can also block another user to stop seeing their posts, comments, reviews, and Parent Solutions Board content in your feed. Blocking is private — the other person is not notified.',
...
export const PRIVACY_POLICY: LegalSection[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      'Community content: Parents Corner posts, comments, likes, product reviews, and Parent Solutions Board problems and solutions.',
  ...
  },
  {
    ...
    bullets: [
      ...
      'Operate community features such as Parents Corner, reviews, and the Parent Solutions Board.',
