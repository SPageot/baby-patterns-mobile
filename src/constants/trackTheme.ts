...
const TrackAccents = {
  light: {
    ...
    behavior: {
      accent: '#c48c5a',
      accentSoft: 'rgba(196, 140, 90, 0.12)',
      accentBorder: 'rgba(196, 140, 90, 0.28)',
      icon: 'tag' as const,
    },
  },
  dark: {
    ...
    behavior: {
      accent: 'rgba(214, 168, 120, 0.95)',
      accentSoft: 'rgba(214, 168, 120, 0.14)',
      accentBorder: 'rgba(214, 168, 120, 0.28)',
      icon: 'tag' as const,
    },
  },
} as const
